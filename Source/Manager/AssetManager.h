...
public: // sound buffers
	...
	SoundBuffer*                                            getSoundBuffer(const std::string& id, bool uuid = false);
	...
	void                                                    removeSoundBuffer(const std::string& id, bool uuid = false);
...
public: // sounds
	...
	Sound*                                                  getSound(const std::string& id, bool uuid = false);
	Sound*                                                  getSoundFront();
	Sound*                                                  getSoundBack();
	std::vector<std::shared_ptr<Sound>>&                    getSoundData();
	void                                                    removeSound(std::size_t index);
	void                                                    removeSound(const std::string& id, bool uuid = false);
	void                                                    removeSound(Sound* sound); // @TODO add other asset counterparts
...
public: // music
	...
	Music*                                                  getMusic(const std::string& id, bool uuid = false);
	Music*                                                  getMusicFront();
	Music*                                                  getMusicBack();
	std::vector<std::shared_ptr<Music>>&                    getMusicData();
	void                                                    removeMusic(std::size_t index);
	void                                                    removeMusic(const std::string& id, bool uuid = false);
	void                                                    removeMusic(Music* music); // @TODO add other asset counterparts
...
public: // fonts
	...
	Font*                                                   getFont(const std::string& id, bool uuid = false);
	Font*                                                   getFontFront();
	Font*                                                   getFontBack();
	std::vector<std::shared_ptr<Font>>&                     getFontData();
	void                                                    removeFont(std::size_t index);
	void                                                    removeFont(const std::string& id, bool uuid = false);
	void                                                    removeFont(Font* font); // @TODO add other asset counterparts
...
public: // texts
	...
	Text*                                                   getText(const std::string& id, bool uuid = false);
	Text*                                                   getTextFront();
	Text*                                                   getTextBack();
	std::vector<std::shared_ptr<Text>>&                     getTextData();
	void                                                    removeText(std::size_t index);
	void                                                    removeText(const std::string& id, bool uuid = false);
	void                                                    removeText(Text * text); // @TODO add other asset counterparts
...
public: // textures
	...
	Texture*                                                getTexture(const std::string& id, bool uuid = false);
	...
	void                                                    removeTexture(const std::string& id, bool uuid = false);
	void                                                    removeTexture(Texture* textures); // @TODO add other asset counterparts
...
public: // shapes
	...
	Shape*                                                  getShape(const std::string& id, bool uuid = false);
	Shape*                                                  getShapeFront();
	Shape*                                                  getShapeBack();
	std::vector<std::shared_ptr<Shape>>&                    getShapeData();
	void                                                    removeShape(std::size_t index);
	void                                                    removeShape(const std::string& id, bool uuid = false);
	void                                                    removeShape(Shape* shape); // @TODO add other asset counterparts
...
public: // tilemaps
	...
	Tilemap*                                                getTilemap(const std::string& id, bool uuid = false); // @TODO uuid bool
	...
	void                                                    removeTilemap(const std::string& id, bool uuid = false);
	void                                                    removeTilemap(Tilemap* tilemap); // @TODO add other asset counterparts
